...
#ifndef _MOL_ALIGNER4C5319E3_H_
#define _MOL_ALIGNER4C5319E3_H_
...
namespace mesaac {
    namespace shape {
        ...
        protected:
            ...
            void get_mean_centered_cloud(
                const PointList& centers, PointList& cloud);
            void find_axis_align_transform(
