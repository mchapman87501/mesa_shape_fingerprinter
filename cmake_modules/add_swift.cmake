...
#
# target: the name of the target to generate headers for. This target must build
# swift source files. header: the name of the header file to generate.
#
...
function(_swift_generate_cxx_header target header)
  ...
  if(NOT DEFINED CMAKE_Swift_COMPILER)
    message(
      WARNING
        "Swift not enabled in project. Cannot generate headers for Swift files."
    )
    return()
  endif()
  ...
  if(NOT ARG_MODULE_NAME)
    ...
    set(ARG_MODULE_NAME
        $<IF:$<BOOL:${target_module_name}>,${target_module_name},${target}>)
  endif()
  ...
  set(_AllSources
      $<PATH:ABSOLUTE_PATH,$<TARGET_PROPERTY:${target},SOURCES>,${CMAKE_CURRENT_SOURCE_DIR}>
  )
