...
TEST_CASE("mesaac::measures::Hamann", "[mesaac]") {
  // These tests are based on the definition of Hamann similarity
  // in https://www.stata.com/manuals/mvmeasure_option.pdf
  Hamann measure;

  SECTION("Get name") { REQUIRE(measure.name() == "Hamann"); }
