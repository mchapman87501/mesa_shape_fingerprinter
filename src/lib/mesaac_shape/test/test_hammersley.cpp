    ...
    public:
        ...
        void testBasic() {
            ...
            while (h.next_point(p)) {
                ...
                CPPUNIT_ASSERT( 0 < p[1] && p[1] <= 1.0);
                CPPUNIT_ASSERT( 0 < p[2] && p[2] <= 1.0);
        ...
        void testGetCubic() {
            ...
            // flattish volume?
            PointList points;
            float xmin = -2.0, xmax =  3.1,
                  ymin =  5.0, ymax = 10.1,
                  zmin =  0.0, zmax = 1.8;
            unsigned int num_points = 10240;
            Hammersley::get_cubic(xmin, xmax, ymin, ymax, zmin, zmax,
                                  num_points, points);
